...
<html lang="en">
    ...
    <body>
        ...
        <script>
             function pay() {
              window.location.href = "${pageContext.request.contextPath}/pay";
            }
            function querydr() {
              window.location.href = "${pageContext.request.contextPath}/querydr";
            }
             function refund() {
              window.location.href = "${pageContext.request.contextPath}/refund";
            }
        </script>
    </body>
</html>